            ...
            <div class="row">
                <div class="col-lg-5 align-self-center">
                    <div class="section-heading">
                        <h6>Tentang Kami</h6>
                        <h2>Mengapa Cipta Paket Wisata dibuat?</h2>
                        {{-- <h2>?</h2> --}}
                        <p>Sistem ini dibuat sebagai media pembantu penyusunan paket wisata untuk membantu penyelenggara wisata di Kabupaten Ketapang.</p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <code>templatemo business templates, templatemo gallery templates, admin dashboard
                                        templatemo, 3-column templatemo, etc.</code>
                                </div>
                            </div>
                        </div>
                    </div>
